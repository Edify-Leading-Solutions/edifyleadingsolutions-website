...
**URL:** [www.edifyls.com](https://www.edifyls.com)

## 🛠 Tech Stack

This project is built to be lightweight, fast, and completely free of complex build steps:

- **HTML5:** Semantic, accessible markup.
- **Tailwind CSS:** Utility-first styling via CDN for rapid UI development.
- **Custom Theming:** Configured with Edify Logic Studio's brand colors (Navy `#21314D` and Red `#EE3224`).

## 📁 Project Structure

- `index.html` - The main landing page detailing services and contact information.
